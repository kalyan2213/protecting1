...
import javax.swing.*;
public class Mobile_Client1 implements ActionListener
{
  JFrame f;
  JFrame ff;
  ...
  public Mobile_Client1() 
  {
	
	  f=new JFrame("Mobile Client1::Protecting Location Privacy During Task Allocation in Mobile Cloud Computing");
	  p=new JPanel();
